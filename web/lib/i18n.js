...
export const DICT = {
  zh: {
    ...
    arch_title: '国家政策原型(聚类)', arch_blurb: '按各国“政策工具组合”用 k-means 聚类,归纳出几类“政策风格”。',
    arch_type: '型', arch_countries: '个国家',
    nav_cross: '联动',
  ...
  en: {
    ...
    arch_title: 'Policy archetypes (clustering)', arch_blurb: 'k-means over each country’s instrument-family mix → distinct "policy styles".',
    arch_type: 'type', arch_countries: 'countries',
