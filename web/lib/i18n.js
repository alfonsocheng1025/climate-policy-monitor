...
export const DICT = {
  zh: {
    ...
    cp_add: '+ 添加国家',
    f_country: '全部国家', f_type: '全部类型', f_source: '全部数据源', loading: '加载中…',
    export_csv: '导出 CSV',
  ...
  en: {
    ...
    cp_add: '+ Add country',
    f_country: 'All countries', f_type: 'All types', f_source: 'All sources', loading: 'Loading…',
    ...
    org: 'Climate & Science Communication',
